...
When picking colours, don't just use white on black, a dark grey is actually easier to read on for most people compared to black. Actually, I'd suggest the same for light mode, use a very light grey background rather than pure white. Remember to check all your text/background colour combinations for [contrast](/quick-wins/text-contrast/) to ensure they reach at least 4.5:1.
...
For full details on implementing dark mode in your apps check out these great guides for [iOS](https://www.raywenderlich.com/10718147-supporting-dark-mode-adapting-your-app-to-support-dark-mode) or [Android](https://www.raywenderlich.com/6488033-android-10-dark-theme-getting-started) from the [Ray Wenderlich team](https://www.raywenderlich.com).
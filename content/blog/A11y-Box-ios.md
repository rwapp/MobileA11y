...
In an attempt to help spread the knowledge of some of the awesome things UIAccessibility is capable of, I've created [A11y Box](https://github.com/rwapp/A11y-Box-iOS) for iOS. It's an open source project that covers every feature I know about on the UIAccessibility API, and a little more too.
